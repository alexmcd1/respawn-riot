...
const sections = [
  ...
  },
  {
    href: "/music",
    tag: "Music",
    title: "Pop Punk + Concert Search",
    body: "Tour news, comeback albums, and live dates for the bands you actually listen to.",
  ...
  },
  {
    href: "/games",
    tag: "Games",
    title: "RC · TDC · JJK · PC Builder · Stars Brawl",
    body: "The whole arcade in one tile grid. Hosted creator games + our in-house RC + the devlog.",
  ...
  },
  {
    href: "/cram",
    tag: "Cram",
    title: "Study Hall · Grades 5–8 first",
    body: "Late-night cram sessions for whatever you need to know. Math flashcards now; more study tools landing here over time.",
